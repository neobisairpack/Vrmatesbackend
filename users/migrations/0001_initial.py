# Generated by Django 3.0.7 on 2020-07-05 03:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rater', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='give_rate', to=settings.AUTH_USER_MODEL)),
                ('receiver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='receive_rate', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
